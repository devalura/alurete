...
export const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  (
    ...
    const baseClasses = 'inline-flex items-center justify-center font-sans font-medium rounded-full whitespace-nowrap transition-all duration-200 ease-in-out';
    ...
    const variantClasses = {
      ...
      outline: {
        success: 'bg-transparent border border-solid border-[var(--color-feedback-success-default)] text-[var(--color-feedback-success-default)]',
        error: 'bg-transparent border border-solid border-[var(--color-feedback-error-default)] text-[var(--color-feedback-error-default)]',
        warning: 'bg-transparent border border-solid border-[var(--color-feedback-attention-default)] text-[var(--color-feedback-attention-default)]',
        info: 'bg-transparent border border-solid border-[var(--color-feedback-info-default)] text-[var(--color-feedback-info-default)]',
        neutral: 'bg-transparent border border-solid border-[var(--color-border-default)] text-[var(--color-text-body)]',
      },
      subtle: {
